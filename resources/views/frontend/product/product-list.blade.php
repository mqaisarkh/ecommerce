                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                <li>
                                    <a href="{{ route('product.grid') }}">Computers & Accessories </a><span>(1138)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">Smartphones & Tablets</a><span>(2356)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">TV, Video & Audio</a><span>(420)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">Cameras, Photo & Video</a><span>(874)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">Headphones</a><span>(1239)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">Wearable Electronics</a><span>(340)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product.grid') }}">Printers & Ink</a><span>(512)</span>
                                </li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <div class="button">
                                                    <a href="{{ route('product.detail') }}" class="btn"><i
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">Xiaomi Mi Band 5</a>
                                                </h4>
                                                <ul class="review">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">Bluetooth Speaker</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">WiFi Security Camera</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">iphone 6x plus</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">Wireless Headphones</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                <span class="category">Speaker</span>
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">Mini Bluetooth Speaker</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product.grid') }}">Apple MacBook Air</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-12">
                                                    <div class="product-info">
                                                        <span class="category">Speaker</span>
                                                        <h4 class="title">
                                                            <a href="{{ route('product.grid') }}">Big Power Sound Speaker</a>
                                                        </h4>
                                                        <ul class="review">
                                                            <li><i class="lni lni-star-filled"></i></li>
                                                            <li><i class="lni lni-star-filled"></i></li>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-12">
                                                    <div class="product-info">
                                                        <span class="category">Headphones</span>
                                                        <h4 class="title">
                                                            <a href="{{ route('product.grid') }}">PX7 Wireless Headphones</a>
                                                        </h4>
                                                        <ul class="review">
                                                            <li><i class="lni lni-star-filled"></i></li>
                                                            <li><i class="lni lni-star-filled"></i></li>
